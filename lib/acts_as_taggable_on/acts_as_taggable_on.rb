      ...
      module SingletonMethods
        ...
        def find_options_for_find_tagged_with(tags, options = {})
          ...
          if options.delete(:exclude)
            tags_conditions = tags.map { |t| sanitize_sql(["#{Tag.table_name}.name #{ActiveRecord::Base.connection.case_insensitive_like} ?", t]) }.join(" OR ")
            ...
            conditions << tags.map { |t| sanitize_sql(["#{tags_alias}.name #{ActiveRecord::Base.connection.case_insensitive_like} ?", t]) }.join(" OR ")
